...
# error "to do"
  ...
  //ag-note: free unsafe stack here
#ifdef AG_SAFE_STACK
  if (pd->ag_unsafe_stack) {
    munmap(pd->ag_unsafe_stack, pd->ag_unsafe_stack_size);
    pd->ag_unsafe_stack = NULL;
    pd->ag_unsafe_stack_size = 0;
  }
#endif
