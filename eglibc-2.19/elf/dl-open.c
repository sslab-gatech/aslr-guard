...
dl_open_worker (void *a)
{
  ...
  //ag-note: FIXME: address is changed, this check may fail
  //for now, I simply remove the check
  _dl_debug_printf("@ check_caller  caller: 0x%lx  mask: 0x%lx \n", 
      args->caller_dl_open, allow_libc|allow_libdl|allow_ldso);
